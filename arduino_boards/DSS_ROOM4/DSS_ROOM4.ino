...
unsigned long myChannelNumber = 2014495;         // Your ThingSpeak channel number
const char *myWriteAPIKey = "2W3PJQL9KAAY2O6F";  // Your ThingSpeak API Key
...
#define TemperatureSensorPin A2   // Analog pin for Temperature Sensor
...
void sendDatatoThingSpeak(){
  ...
  // Set fields
  ThingSpeak.setField(1, averageIlluminance);
  ThingSpeak.setField(2, averageTemperature);
  ThingSpeak.setField(3, averageNoise);
  ThingSpeak.setField(4, PIRMotionAccumulator);
